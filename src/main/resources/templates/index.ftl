...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="menu-nav">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">大学生论坛</a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#ad-carousel">高校区</a></li>
                <li><a href="#summary-container">专业区</a></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">杂谈区<span class="caret"></span></a>
...
<div id="ad-carousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="static/images/wxxy.png" alt="1 slide">

            <div class="container">
                <div class="carousel-caption">
                    <h1>皖院</h1>

                    <p>皖西学院（West Anhui University）坐落在月亮岛的梦幻校园。</p>

                    <p><a class="btn btn-lg btn-primary" href="http://www.wxc.edu.cn/"
                          role="button" target="_blank">点此链接</a></p>
                </div>
            </div>
        </div>
        <div class="item">
            <img src="static/images/anhuigongchengdaxue.jpg" alt="2 slide">
        ...
        <div class="item">
            <img src="static/images/safari-big.jpg" alt="3 slide">
        ...
        <div class="item">
            <img src="static/images/opera-big.jpg" alt="4 slide">
        ...
        <div class="item">
            <img src="static/images/ie-big.jpg" alt="5 slide">
...
<div class="container summary">
    ...
    <div class="row" id="summary-container">
        <div class="col-md-4">
            <img class="img-circle" src="static/images/chrome-logo-small.jpg" alt="chrome">
        ...
        <div class="col-md-4">
            <img class="img-circle" src="static/images/firefox-logo-small.jpg" alt="firefox">
        ...
        <div class="col-md-4">
            <img class="img-circle" src="static/images/safari-logo-small.jpg" alt="safari">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab-chrome">
            <div class="row feature">
                ...
                <div class="col-md-5">
                    <img class="feature-image img-responsive" src="static/images/chrome-logo.jpg"
                         alt="Chrome">
                </div>
            </div>
        </div>
        <div class="tab-pane" id="tab-firefox">
            <div class="row feature">
                <div class="col-md-5">
                    <img class="feature-image img-responsive" src="static/images/firefox-logo.jpg"
                         alt="Firefox">
                </div>
                <div class="col-md-7">
        ...
        <div class="tab-pane" id="tab-safari">
            <div class="row feature">
                ...
                <div class="col-md-5">
                    <img class="feature-image img-responsive" src="static/images/safari-logo.jpg"
                         alt="Safari">
                </div>
            </div>
        </div>
        <div class="tab-pane" id="tab-opera">
            <div class="row feature">
                <div class="col-md-5">
                    <img class="feature-image img-responsive" src="static/images/opera-logo.jpg"
                         alt="Opera">
                </div>
                <div class="col-md-7">
        ...
        <div class="tab-pane" id="tab-ie">
            <div class="row feature">
                ...
                <div class="col-md-5">
                    <img class="feature-image img-responsive" src="static/images/ie-logo.jpg"
                         alt="IE">
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>大学生论坛三大目标：1、为高中生选择高校提供一个高校信息平台 2、让在读大学生吸取成功的学长学姐分享的学习经验和毕业后的工作经验
                    让大学里自学方向更明确，更贴近社会需求 3、赠人玫瑰，手有余香；帮助他人，快乐自己</p>
                </div>
    ...
    <footer>
        ...
        <p>&copy; 2018 All rights reserved 大学生论坛 </p>
    </footer>
